...
public class AttendanceRecord {
    ...
    // Constructor for SharedDataManager compatibility
    public AttendanceRecord(String studentID, String subjectCode, String date, String status, String remarks) {
        this.studentID = studentID;
        this.subjectCode = subjectCode;
        this.subjectName = ""; // Will be set later if needed
    ...
    public String getDateString() { return date.format(DateTimeFormatter.ofPattern("yyyy-MM-dd")); }

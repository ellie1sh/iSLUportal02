...
public class MyDoublyLinkedList<T> implements MyList<T>, Iterable<T> {
    ...
    public T set(int index, T data) {
        ...
        DoublyLinkedNode<T> node = getNodeAt(index);
    ...
    /**
     * Get the size of the list (MyList interface requirement)
     */
    @Override
    public int size() {
        return size;
    ...
    private class ForwardIterator implements Iterator<T> {
        ...
        public void remove() {
            ...
            MyDoublyLinkedList.this.remove(indexOf(lastReturned.getData()));
            expectedSize--;
            lastReturned = null;
        }
    ...
    private class ReverseIterator implements Iterator<T> {
        ...
        public void remove() {
            ...
            MyDoublyLinkedList.this.remove(lastIndexOf(lastReturned.getData()));
            expectedSize--;
            lastReturned = null;
        }
    ...
    // ========== MyList Interface Implementation ==========
